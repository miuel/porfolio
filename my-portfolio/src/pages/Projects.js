  ...
  return (
    <section className="overflow-auto max-w-6xl m-auto">
      <div className="p-10 gap-8">
        ...
        <div className="py-5 border-b border-y-stone-400 h-64 lg:h-[480px]">
          <Carousel>
            <img fetchpriority="high" loading="lazy" src={data.naturvardsverket} alt={data.naturvardsverket} />
            <img fetchpriority="low" loading="lazy" src={data.sverigesnationalparker} alt="..." />
            <img fetchpriority="low" loading="lazy" src={data.lavinprognoser} alt="..." />
